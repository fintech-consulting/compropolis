								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header orange lighter ">
											...
											<form id="form" method="POST" class="form-horizontal" role="form">
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
                                                                                                                    <input type="checkbox" class="ace" name="recordarme" id="recordarme" />
															<span class="lbl"> Recordarme</span>
														</label>

                                                                                                            <button id="ingresarBtn" type="button" class="width-35 pull-right btn btn-sm btn-primary">
											...
											<div class="social-or-login center">
												<span class="bigger-110">ó ingresa utilizando</span>
											</div>
											...
											<div class=" center">
												<a class="btn btn-primary btn-block">
													<i class="ace-icon fa fa-facebook"></i>acebook
												</a>
                                                                                            <!--
												...
												<fieldset>
													...
													<div class="clearfix">
														<button type="button" class="pull-right btn btn-sm btn-danger">
															...
															<span class="bigger-110">Restablecer Contraseña</span>
														</button>
													</div>
												</fieldset>
											</form>
										...
										<div class="widget-main">
											<h4 class="header green lighter bigger">
												<i class="ace-icon fa fa-users blue"></i>
                                                                                                Crear cuenta de <b>nuevo usuario</b>
											</h4>
...
//                alert(data);
                if( data.success == true ){
                    ...
                    alert("se ha logeado al usuario");
