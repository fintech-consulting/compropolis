        ...
        <div class="widget-main">
            ...
            <form id="form" action="/compropolis/admin/categoria/salvar" method="POST" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nombre de Usuario: </label>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Rol: </label>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Confirmar Contraseña: </label>
