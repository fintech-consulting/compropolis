...
<a href="<?= $this->url->get('admin/categoria/nueva') ?>" class="btn btn-sm btn-success">
		...
		<div>
			<table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr id=<?= $categoria->getIdCategoria() ?>>
						<td class="center">
							<label class="position-relative">
						...
						<td><img src="..<?= $categoria->getPathImagen() ?>" width="20%" alt=""></td>
						<td>Feb 12</td>
